...
// Hitung total data
$total_query = "SELECT COUNT(*) AS total FROM materi WHERE jenis_level_id = ? AND id_kategori = 2";
...
$query = "SELECT * FROM materi WHERE jenis_level_id = ? AND id_kategori = 2 LIMIT ? OFFSET ?";
