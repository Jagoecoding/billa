...
<body>
    ...
    <div class="main-content">
        <h1>Tentukan tingkat kesulitan codingmu Di Bahasa Python!</h1>
        ...
        <div class="card-container">
            <div class="card">
                ...
                <button onclick="location.href='easy-level-python.php?level=1'">Yuk, Mulai!</button>
            </div>
            <div class="card">
                <h3>Medium</h3>
                <p>Sedikit lebih menantang. Tingkatkan skill-mu.</p>
                <img src="image/tantangan2.png" alt="Medium Level">
                <button onclick="location.href='medium-level-python.php?level=2'">Yuk, Mulai!</button>
            </div>
            <div class="card">
                <h3>Hard</h3>
                <p>Siap diuji? Tantangan terbaik ada di sini.</p>
                <img src="image/tantangan3.png" alt="Hard Level">
                <button onclick="location.href='hard-level-python.php?level=3'">Yuk, Mulai!</button>
            </div>
        </div>
    </div>
</body>
