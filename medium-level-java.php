...
$level = isset($_GET['level']) ? htmlspecialchars($_GET['level']) : 'medium';
...
// Hitung total data
$total_query = "SELECT COUNT(*) AS total FROM materi WHERE jenis_level_id = ? AND id_kategori = 3";
...
$query = "SELECT * FROM materi WHERE jenis_level_id = ? AND id_kategori = 3 LIMIT ? OFFSET ?";
$stmt = mysqli_prepare($conn, $query);
mysqli_stmt_bind_param($stmt, 'sii', $level, $items_per_page, $offset);
